<template>
  <div>
    <div class="menu-container">
      <div class="nav-logo">
        <img src="@/assets/timg.png" class="logo-img">
        <span class="logo-text">似水流年</span>
      </div>
      <div class="nav-menu-search">
        <a-menu v-model="current" mode="horizontal">
          ...
          <a-menu-item key="3">
            <router-link to="/my-album">
              <a-icon type="mail" />个人相册
            </router-link>
          </a-menu-item>
          <a-menu-item key="4">
            <router-link to="/about">
              <a-icon type="setting" />关于我的
            </router-link>
          </a-menu-item>
        </a-menu>
        <a-input-search
          ...
          <template>
            <a-dropdown>
              ...
              <a-menu slot="overlay">
                ...
                <a-menu-item>
                  <router-link to="/about">我的评论 </router-link>
                </a-menu-item>
                <a-menu-item>
