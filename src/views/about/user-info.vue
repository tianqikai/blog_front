    ...
    <div class="info-container">
      <div class="header-container">
        ...
        <div class="meta-container">
          ...
          <div class="user-collection">收藏 ( {{ dataCount.collectionCount ==undefined ? 0:dataCount.collectionCount }} ) 评论 ( {{ dataCount.commentCount==undefined?0:dataCount.commentCount }} )</div>
          <a-divider />
          <div class="info-form">
